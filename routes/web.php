...
Route::post('/removeBooking', [BookingController::class, 'removeBooking'])->name('removeBooking')->middleware('auth');

Route::post('/acceptBooking', [BookingController::class, 'acceptBooking'])->name('acceptBooking')->middleware('auth');
